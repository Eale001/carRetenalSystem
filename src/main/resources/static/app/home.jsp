								...
								<tbody>
									<tr>
										...
										<td width="132" align="left">
                                            ...
                                            <input type="hidden" name="CityID" id="CityID" value=""></td>
										<td align="left">
									...
									<tr>
										...
										<td align="left"><input type="text" name="retCity" id="retCity" onclick="" class="borinp" value="" readonly=""><input type="hidden" name="retCityID" id="retCityID" value=""></td>
										<td align="left"><input name="retStore" id="retStore" onclick="" type="text" class="borinp" value="" readonly=""><input type="hidden" name="retStoreID" id="retStoreID" value=""></td>
									...
									<tr>
										...
										<td align="left">
											...
											<input type="date" name="getdate" id="d123" class="borinp" onfocus=""></td>
										<td align="left">
										</td>
									</tr>
									<tr>
										<td height="44" align="center"><strong>还车时间：</strong></td>
										<td align="left"><input type="datetime-local" name="retdate" id="d124" value="" class="borinp" onclick="redate();"></td>
										<td align="left">
										</td>
									</tr>
									<tr>
...
-->
        ...
        <ul class="subnav">
			...
			<img src="./北京市顺天时汽车租赁有限公司_北京汽车租赁_汽车长租_汽车短租_files/tu_117.gif">
