		...
		<div class="main">
			...
			<div class="newlist" style="width:1180px">
				<div class="t1">
					...
					<img src="./车辆预订1_files/tu_10.gif" width="22" height="21">
					<h2>确认订单</h2>
					<font>您的位置：
				...
				<form name="myform" action="#" method="post">
					...
					<div class="ddmx-content">
						<div class="ddmx-main">
							...
							<ul class="ddmx-right">
								<li>
									<div class="inf-name"><span class="value">别克凯悦&nbsp;&nbsp;&nbsp; 自动档//</span><br>
										<p>
											短租：<strong>
                                       200</strong>元/天 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<br> 预授权：
										...
										<tbody>
											<tr>
												...
												<td width="40%" bgcolor="#FFFFFF">
													<div class="s_box"><input class="city" id="getcityname" readonly="" type="text" value="西三环店"><span class="sel-city" id="PickupCity" onclick="getStoreOnClick();stopBubble(event);">[选择]</span>
											...
											<tr>
												...
												<td width="40%" bgcolor="#FFFFFF">
													<div class="s_box"><input class="city" id="retcityname" readonly="" type="text" value="西三环店"><span class="sel-city" id="PickupCity" onclick="retStoreOnClick();stopBubble(event);">[选择]</span>
							...
							<div style="margin:10px 0 10px 300px"><input type="button"  border="0" value="确认订单" name="submit2" /></div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
					</div>
