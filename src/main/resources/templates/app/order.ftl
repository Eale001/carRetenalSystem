...
<html>
    ...
    <div class="newlist" style="width:1180px">
        ...
        <form name="myform" id="myform" action="/cusomersaveOrder" method="post" onsubmit="return CheckSubmit();">
                ...
                <div class="ddmx-main">
                    ...
                    <ul class="ddmx-right">
                        <li>
                            <div class="inf-name">
                                <span class="value">
                                <input class="value" name="vehicleName" value="${(vehicleName)!"凯迪拉克"}">
                                    &nbsp;&nbsp;&nbsp; 自动档//
                                </span>
                                <br>
                                <p>
                                    短租：<input id="price" name="price" value="${(vehiclePrice)!"200"}"> 元/天
                                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                        ...
                        <li class="bot"><table border="0" width="100%" cellspacing="1" bgcolor="#ddd" style="margin-top:10px">
                            <tbody><tr>
                                ...
                                <td width="34%" bgcolor="#FFFFFF">
                                    <input type="text" name="beginTime" value="${(order.beginTime)?string("yyyy-MM-dd HH:mm:ss")}" readonly>
                                </td>
                                <td width="16%" bgcolor="#eeeeee" align="center">取车地点：</td>
                                <td width="34%" bgcolor="#FFFFFF">
                                    <input name="vehiclegetAddr" value="${(order.vehiclegetAddr)!""}" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td width="16%" height="30" align="center" bgcolor="#eeeeee" class="key">还车时间：</td>
                                <td width="34%" bgcolor="#FFFFFF">
                                    <input type="text" name="endTime" value="${(order.endTime)?string("yyyy-MM-dd HH:mm:ss")}" readonly>

                                </td>
                                <td width="16%" bgcolor="#eeeeee" align="center">还车地点：</td>
                                <td width="34%" bgcolor="#FFFFFF">
                                    <input name="vehiclebackAddr" value="${(order.vehiclebackAddr)!""}" readonly>
                                </td>
                            </tr>
                                ...
                                <td colspan="4" bgcolor="#FFFFFF">
                                    ...
                                    <table width="90%" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            ...
                                            <td width="28%" class="tdbg"><input type="text" name="orderName" id="ContactMan" value="" maxlength="50"></td>
                                            <td width="10%"><font color="red">*</font>手  机</td>
                                            <td width="49%"><input type="text" value="" id="orderPhone" name="orderPhone" maxlength="50"></td>
                                        </tr>
                                        <tr>
                                            <td><font color="red">*</font>证件类型</td>
                                            <td><select name="icardType" id="CardType" class="borinp"><option value="身份证">身份证</option></select></td>
                                            <td><font color="red">*</font>证件号码</td>
                                            <td><input type="text" id="CardNumber" name="icard" value="" maxlength="20"></td>
                                        </tr>
                                ...
                                <td colspan="4" bgcolor="#fffbf8">
                                    <table width="95%" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            ...
                                            <td width="13%"><span class="fz14 f60"><b id="mianpei">￥50</b></span>元/天</td>
                                ...
                                <td colspan="4" bgcolor="#fffbf8">
                                    <table width="95%" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            ...
                                            <td width="13%"><span class="fz14 f60"><b id="gps">￥10</b></span>元/天</td>
                                            <td width="70%"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                                ...
                                <td colspan="4" bgcolor="#fffbf8">
                                    <table width="95%" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            ...
                                            <td width="13%"><span class="fz14 f60"><b id="chirdSeat">￥100</b></span>元/天</td>
                                            <td width="70%"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td width="70%">
                                                <div class="feeDay">
                                                        ...
                                                        <span class="sz_priceBlueSmall"><em class="rmb">￥</em><em class="num">
                                                            <input class="num" name="vehiclePrice" value="${(order.vehicle.vehiclePrice)!"200"}">
                                                        </em></span>
                                                    </div>

                                                <div class="feeTotalDay">共<span>
                                                    <input id="dayTime" name="dayTime" value="1">
                                                </span>天</div>
                                            </td>
                                            <td width="11%"><span class="sz_OrderpOrangeM"><em class="rmb">￥</em><em class="num">
                                                <input class="num" name="vehiclePrice" value="${(order.vehicle.vehiclePrice)!"200"}">
                                            </em></span></td>
                                        </tr>
                                    </tbody></table>
                            ...
                            <tr>
                                ...
                                <span class="sz_OrderpOrangeM">
		                            <em class="rmb">￥</em>
                        <em class="num">
                           <input id="banxian" name="baoxian" value="40">
                        </em>                        </span></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                        ...
                        <#--<em class="num" id="price3">100</em>                        </span></td>-->
                            ...
                            <tr>
                                <td colspan="4" bgcolor="#fffbf8">
                                    <table width="95%" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            ...
                                            <td width="70%">&nbsp;</td>
                                            <td width="11%"><span class="sz_OrderpOrangeM"><em class="rmb">￥</em><em class="num" id="shouxufei">20</em></span></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
                                ...
                                <table width="95%" border="0" cellpadding="0" cellspacing="0">
                                    <tbody><tr>
                                        <td width="11%"></td>
                                        <td width="70%" align="right"><input type="hidden" name="ordermoney" id="priceCount" value="169"><b>订单总价：</b></td>
                                        <td width="38%"><span class="sz_OrderpOrangeB"><em class="rmb">￥</em><em class="num" id="pricetext">
                                            <input name="money" value="260">
                                        </em></span></td>
                                    </tr>
                                </tbody></table>
                            </td></tr>
