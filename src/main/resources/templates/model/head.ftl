<div class="color">
	<div class="hred">
		<div class="headtop">
			...
			<form method="get" action="/customerLogins">
				<div class="p2">
					<span id="LoginPanel">
                    <table width="100%" border="0">
                        <tbody><tr><td width="320px">用户名：<input type="text" class="loginbor" name="userName" value="${(user.userName)!''}">
                            密码：<input type="password" class="loginbor" name="passWord"></td>
                            <td width="250px">
								<button class="btnok" type="">登录</button>
                                <button  class="btnreg" type="button">注册</button>&nbsp;
                                <a href="#">找回密码</a> </td></tr>
                        </tbody>
                    </table>
                </span>
